...
const bucket_slug = process.env.COSMIC_BUCKET || 'ff4313d0-4acc-11e8-9923-8d06faacb64e'
...
http.listen(app.get('port'), () => {
  console.info('Aplikacja uruchomiona pod adresem: http://localhost:%s', app.get('port'));
})
